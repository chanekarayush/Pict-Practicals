...
mysql> DELIMITER //
mysql>
mysql> CREATE PROCEDURE ReturnBook(IN p_roll_no INT, IN p_name_of_book VARCHAR(100))
    ->     BEGIN
...
### Error Handling For Missing Book

```sql
mysql> CALL ReturnBook(999, 'BOOK XYZ')//
+--------------------------------------------------------------------------------------------+
| ErrorMessage                                                                               |
+--------------------------------------------------------------------------------------------+
| An error occurred. Error Code: 45000, Message: No book record found or book is not issued. |
+--------------------------------------------------------------------------------------------+
...
| ErrorMessage                                                             |
+--------------------------------------------------------------------------+
| The book record was not found for the provided Roll Number and Book Name |
+--------------------------------------------------------------------------+
...
| ResultMessage                       |
+-------------------------------------+
| Book returned. Fine amount: Rs 0.00 |
+-------------------------------------+
